...
public class PythagoreanTripleFinder
{
    ...
    private void pythagoreanTripleFinder()
    {
        ...
        frame.setInstructionsMenuBar("Please enter two numbers, and then press Calculate to find a Pythagorean Triple:");
        frame.add(new StandardLabel("First Number:"));
        setupFirstNumberField();
        frame.add(firstNumberField);
        frame.add(new StandardLabel("Second Number:"));
